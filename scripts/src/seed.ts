...
const hotels = [
  {
    name: "Grand Palace Hà Nội",
    location: "Hà Nội",
    city: "Hà Nội",
    address: "18 Lý Thường Kiệt, Hoàn Kiếm, Hà Nội",
    description: "Tọa lạc tại trung tâm lịch sử Hà Nội, Grand Palace Hà Nội mang đến trải nghiệm nghỉ dưỡng sang trọng đẳng cấp với view hồ Hoàn Kiếm huyền thoại. Kiến trúc Pháp cổ điển kết hợp cùng nội thất hiện đại tạo nên không gian vừa tinh tế vừa ấm cúng.",
    rating: "4.9",
    ...
    email: "hanoi@grandpalace.vn",
  },
  {
    name: "Grand Palace Đà Nẵng",
    location: "Đà Nẵng",
    city: "Đà Nẵng",
    address: "120 Võ Nguyên Giáp, Mỹ An, Ngũ Hành Sơn, Đà Nẵng",
    description: "Nằm ngay trên bãi biển Mỹ Khê thơ mộng, Grand Palace Đà Nẵng là thiên đường nghỉ dưỡng biển với tầm nhìn panorama ra biển Đông. Mỗi căn phòng đều được thiết kế để tối ưu hóa ánh sáng tự nhiên và gió biển trong lành.",
    rating: "4.8",
    ...
    email: "danang@grandpalace.vn",
  },
  {
    name: "Grand Palace Hồ Chí Minh",
    location: "Hồ Chí Minh",
    city: "Hồ Chí Minh",
    address: "8 Công Trường Lam Sơn, Bến Nghé, Quận 1, TP.HCM",
    description: "Biểu tượng của sự xa hoa giữa lòng thành phố năng động nhất Việt Nam, Grand Palace Hồ Chí Minh là điểm đến của giới thượng lưu. Tòa tháp 45 tầng với thiết kế đương đại mang đến tầm nhìn toàn cảnh thành phố choáng ngợp.",
    rating: "4.9",
