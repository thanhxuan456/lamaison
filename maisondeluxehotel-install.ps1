...
# Domain: maisondeluxehotel.com (Let's Encrypt SSL via win-acme)
...
$LogFile       = Join-Path $env:TEMP ("MaisonDeluxeHotel_" + (Get-Date -Format "yyyyMMdd_HHmmss") + ".log")
$TempDir       = Join-Path $env:TEMP "MaisonDeluxeHotelSetup"
