      ...
      <section id="destinations" className="py-24 bg-background relative">
        ...
        <div className="container mx-auto px-4 md:px-8 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-primary font-serif tracking-[0.2em] text-sm uppercase mb-4">Các Điểm Đến</h2>
            <h3 className="text-3xl md:text-5xl font-serif text-foreground mb-6">Nơi Cảm Xúc Thăng Hoa</h3>
          ...
          {isLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {hotels?.map((hotel, index) => {
                // Map custom generated images based on city
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1 relative">
              ...
              <div className="absolute -bottom-8 -right-8 w-48 h-48 bg-primary/10 border border-primary/30 z-20 flex items-center justify-center p-6 text-center backdrop-blur-sm hidden md:flex">
                <p className="font-serif italic text-primary text-lg">"Nghệ thuật ẩm thực đỉnh cao"</p>
              </div>
            </div>
            
            <div className="order-1 lg:order-2">
              <h2 className="text-primary font-serif tracking-[0.2em] text-sm uppercase mb-4">Trải Nghiệm</h2>
              <h3 className="text-3xl md:text-5xl font-serif text-white mb-6 leading-tight">Dấu Ấn Khó Phai</h3>
              <div className="w-16 h-[2px] bg-primary mb-8"></div>
              <p className="text-white/70 text-lg font-light leading-relaxed mb-8">
                Tại Grand Palace, mỗi khoảnh khắc đều được thiết kế để trở thành một kỷ niệm vô giá. Từ nghệ thuật ẩm thực tinh tế tại các nhà hàng đạt sao Michelin, đến những liệu trình spa phục hồi sinh lực, chúng tôi mang đến một định nghĩa mới về sự xa xỉ.
              </p>
              <ul className="space-y-4 mb-10">
                {['Ẩm thực đẳng cấp quốc tế', 'Spa & Wellness chuẩn 5 sao', 'Dịch vụ quản gia cá nhân', 'Không gian tổ chức sự kiện sang trọng'].map((item, i) => (
