...
export function ClassicTemplate({ hotel, summary, rooms, loadingSummary, loadingRooms, fmtPrice, t, heroImage }: HotelTemplateProps) {
  return (
    <>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed font-light mb-8 whitespace-pre-line">{hotel.description}</p>
