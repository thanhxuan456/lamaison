...
const clerkAppearance = {
  ...
  elements: {
    ...
    formFieldLabel: { color: "hsl(222, 25%, 15%)", letterSpacing: "0.2em", textTransform: "uppercase", fontSize: "11px" },
    ...
    socialButtonsBlockButton: "border border-[hsl(46,65%,52%,0.4)] hover:border-[hsl(46,65%,52%)] !rounded-none transition-colors",
